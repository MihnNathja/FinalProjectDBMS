...
namespace DBMSProject.DAO
{
    ...
    public class DBConnection
    {
        ...
        static SqlConnection connAdmin = new SqlConnection("Data Source=HARRY;Initial Catalog=QuanLyDichVuQuanNet;Persist Security Info=True;User ID=sqlDependency;Password=sqlDependency;");
